...
%MSXtk%\MSXimg.exe datasrc\font.png -copy datasrc\gfx.txt -out %Dest%\data_font.h -pos 0 0 -size 8 8 -num 16 4 -trans 0xFF000000 -bpc 1 -name g_Font -font 8 8 0x20 _
